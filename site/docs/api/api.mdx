...
<ApiField
  ...
  description="Type specifies the type of the filter configuration.<br />Currently, only ExternalProcess is supported, and default is ExternalProcess."
/><ApiField
