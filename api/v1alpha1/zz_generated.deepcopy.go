...
func (in *AIGatewayFilterConfig) DeepCopyInto(out *AIGatewayFilterConfig) {
	*out = *in
	if in.ExternalProcess != nil {
		...
		*out = new(AIGatewayFilterConfigExternalProcess)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AIGatewayFilterConfigExternalProcess) DeepCopyInto(out *AIGatewayFilterConfigExternalProcess) {
	*out = *in
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AIGatewayFilterConfigExternalProcess.
func (in *AIGatewayFilterConfigExternalProcess) DeepCopy() *AIGatewayFilterConfigExternalProcess {
	if in == nil {
		return nil
	}
	out := new(AIGatewayFilterConfigExternalProcess)
