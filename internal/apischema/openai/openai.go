...
type ChatMessagePart struct {
	...
	ImageURL *ChatMessageImageURL `json:"image_url,omitempty"` //nolint:tagliatelle //follow openai api
}
...
type ChatCompletionMessage struct {
	...
	FunctionCall *FunctionCall `json:"function_call,omitempty"` //nolint:tagliatelle //follow openai api

	// For Role=assistant prompts this may be set to the tool calls generated by the model, such as function calls.
	ToolCalls []ToolCall `json:"tool_calls,omitempty"` //nolint:tagliatelle //follow openai api

	// For Role=tool prompts this should be set to the ID given in the assistant's prior request to call a tool.
	ToolCallID string `json:"tool_call_id,omitempty"` //nolint:tagliatelle //follow openai api
}
...
type ChatCompletionRequest struct {
	...
	// FunctionCall Deprecated: use ToolChoice instead.
	// Docs: https://platform.openai.com/docs/api-reference/chat/create#chat-create-function_call
	FunctionCall any `json:"function_call,omitempty"` //nolint:tagliatelle //follow openai api
